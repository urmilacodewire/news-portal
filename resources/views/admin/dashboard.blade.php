                  ...
                  <div class="col-xl-3">
                     ...
                     <div class="col-xl-3">
                        <a href="{{URL::to('admin/posts')}}">
                           <div class="card card-custom bg_gradient card-stretch gutter-b">
                              <div class="card-body">
                                 <span class="font-weight-bold text-white font-size-sm">Total Posts</span>
                                 <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">{{$posts}}</span>
                     ...
                     <div class="col-xl-3">
                        <a href="{{URL::to('admin/e-paper')}}">
                           <div class="card card-custom bg_gradient card-stretch gutter-b">
                              <div class="card-body">
                                 <span class="font-weight-bold text-white font-size-sm">Total E-Papers</span>
                                 <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">{{$epapers}}</span>
                        ...
                        <a href="{{URL::to('admin/video')}}">
                           <div class="card card-custom bg_gradient card-stretch gutter-b">
                              <div class="card-body">
                                 ...
                                 <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">{{$videos}}</span>
