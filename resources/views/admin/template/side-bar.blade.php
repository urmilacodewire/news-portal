                ...
                <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                    ...
                    <div class="brand flex-column-auto" id="kt_brand">
                        ...
                        <a href="#" class="brand-logo">
                            <img alt="Logo" src="{{url('assets/logo/logo.png')}}" height="60" />
                    ...
                    <!--begin::Aside Menu-->
                    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper" style="background-color: #a100ff;">
                        ...
                        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                            ...
                            <ul class="menu-nav">
                                ...
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="{{URL::to('admin/posts')}}" class="menu-link">
                                        <span class="svg-icon menu-icon">
                                ...
                                <!-- Epaper -->
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="{{URL::to('admin/e-paper')}}" class="menu-link">
                                        <span class="svg-icon menu-icon">
                                        ...
                                        <span class="menu-text">E-Paper</span>
                                    </a>
                                </li>      
                                <!-- End Epaper -->
                                 ...
                                 <!-- Videos -->
                                 <li class="menu-item" aria-haspopup="true">
                                    <a href="{{URL::to('admin/video')}}" class="menu-link">
                                        <span class="svg-icon menu-icon">
